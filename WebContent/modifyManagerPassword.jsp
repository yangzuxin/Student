...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/updatepassword.js"></script>
<style type="text/css">
body {
	padding-top: 40px;
	padding-bottom: 40px;
...
<body>
	<form action="modifyManagerPassword" class="form-signin" method="post"
		...
		<table>
			...
			<tr>
				<td></td>
				<td><button class="btn btn-primary" type="submit">修改</button> <input
					type="reset" class="btn btn-success" value="清 除"></td>
				<td></td>
			</tr>
		</table>
